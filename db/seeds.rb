...
gnomes << Gnome.create!(name: "Gnome with lantern", description: "A gnome holding a small lantern", price: 11.59, user: users.sample, image_path: "gnome5.jpeg")

gnomes << Gnome.create!(name: "Gnome with watering can", description: "A gnome with a watering can", price: 9.59, user: users.sample, image_path: "gnome6.jpeg")
...
gnomes << Gnome.create!(name: "Gnome with shovel", description: "A gnome holding a small shovel", price: 8.99, user: users.sample, image_path: "gnome9.jpeg")

gnomes << Gnome.create!(name: "Gnome with flowers", description: "A gnome holding a bouquet of flowers", price: 12.59, user: users.sample, image_path: "gnome10.jpeg")
